...
<div class="app-content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h3 class="mb-0">Tambah SLA Rule</h3>
            </div>
            <div class="col-sm-6">
            ...
            <form action="{{ route('admin.sla-rules.store') }}" method="POST">
                ...
                <div class="card-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="response_time" class="form-control @error('response_time') is-invalid @enderror" id="response_time" value="{{ old('response_time') }}" min="1" required>
                        @error('response_time')
                            <div class="invalid-feedback">
                                {{ $message }}
                            </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="number" name="resolution_time" class="form-control @error('resolution_time') is-invalid @enderror" id="resolution_time" value="{{ old('resolution_time') }}" min="1" required>
