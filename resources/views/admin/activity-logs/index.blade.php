        ...
        <div class="container-fluid">
            <div class="card border-0 shadow-sm rounded-4">
                <div class="card-header bg-transparent border-0 px-3 pt-3 pb-1">
                    ...
                    {{-- Filter --}}
                    <form method="GET" action="{{ route('admin.activity-logs.index') }}" class="row g-2 align-items-end pb-2">
                        ...
                        <div class="col-12 col-md-3">
                            ...
                            <select name="action" id="action" class="form-select form-select-sm">
                                ...
                                @foreach ([
                                    'Ticket created', 'Ticket assigned', 'Priority changed', 'Status changed',
                                    'Comment added', 'Attachment uploaded', 'Ticket resolved', 'Ticket reopened',
                                    'Ticket escalated', 'SLA overdue detected',
                                ] as $actionOption)
