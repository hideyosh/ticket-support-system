    ...
    <div class="app-content">
        <div class="container-fluid">
            ...
            <div class="card card-primary card-outline">
                ...
                <form action="{{ route('supervisor.tickets.store') }}" method="POST">
                    @csrf
                                    ...
                                    <div class="dropdown-menu w-100 p-2 shadow border-0 rounded-4"
                                        ...
                                        @empty
                                            <p class="text-muted small mb-0 px-2 py-2">
                                                <i class="bi bi-info-circle me-1"></i> Belum ada label tersedia.
                                            </p>
                                        @endforelse
                                    </div>
                                </div>
                    ...
                    <div class="card-footer">
                        ...
                        <a href="{{ route('supervisor.tickets.index') }}" class="btn btn-secondary ms-1">
