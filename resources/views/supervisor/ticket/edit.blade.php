        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-end">
                    <li class="breadcrumb-item"><a href="{{ route(auth()->user()->dashboardRoute()) }}">Home</a></li>
                    <li class="breadcrumb-item"><a href="{{ route('supervisor.tickets.index') }}">Tiket</a></li>
                    <li class="breadcrumb-item">
                        <a href="{{ route('supervisor.tickets.show', $ticket) }}">{{ $ticket->ticket_number }}</a>
                    </li>
...
<div class="app-content">
    <div class="container-fluid">
        ...
        <div class="card card-warning card-outline">
            ...
            <form action="{{ route('supervisor.tickets.update', $ticket) }}" method="POST">
                @csrf @method('PUT')
                ...
                <div class="card-footer">
                    ...
                    <a href="{{ route('supervisor.tickets.show', $ticket) }}" class="btn btn-secondary ms-1">
